<template>
    ...
    <div class="shopping_cart2" v-if="store.openCart">
        <div class="container">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn-close mt-1" data-bs-dismiss="offcanvas" aria-label="Close"
                    @click="store.openCart = !store.openCart"></button>
            </div>
